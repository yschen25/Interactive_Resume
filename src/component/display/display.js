        ...
        return Object.entries(data.clicked).map((val) => {
            ...
            if (val[1].show) {
                ...
                if (val[0] === 'rose' && val[1].show) {
                    display = <div>
                        <svg id="svg" viewBox="0 0 188 264">
                            <defs>
                                <radialgradient id="gradient-0" gradientUnits="userSpaceOnUse" cx="-107.308"
                                                cy="104.329"
                                                r="59.181"
                                                gradientTransform="matrix(0.261752, 0.411262, -0.686293, 0.596934, 160.094667, 49.38985)">
                                    <stop offset="0" stopColor="rgb(255, 0, 0);"/>
                                    <stop offset="1" stopColor="rgb(141, 41, 41);"/>
                                </radialgradient>
                                ...
                                <radialgradient id="gradient-6" gradientUnits="userSpaceOnUse" cx="43.926" cy="85.895"
                                    ...
                                    <stop offset="0" stopColor="rgb(56, 16, 16);"/>
                                ...
                                <radialgradient id="gradient-8" gradientUnits="userSpaceOnUse" cx="99.231" cy="116.778"
                                    ...
                                    <stop offset="0" stopColor="rgb(51, 13, 13);"/>
                                    <stop offset="1" stopColor="rgb(255, 0, 0);"/>
                                </radialgradient>
                                <radialgradient id="gradient-9" gradientUnits="userSpaceOnUse" cx="77.314" cy="119.309"
                                    ...
                                    <stop offset="0" stopColor="rgb(115, 42, 42);"/>
                                    <stop offset="1" stopColor="rgb(255, 0, 0);"/>
                                </radialgradient>
                                ...
                                <radialgradient id="gradient-11" gradientUnits="userSpaceOnUse" cx="87.793" cy="121.847"
                                    ...
                                    <stop offset="0" stopColor="rgb(255, 0, 0);"/>
                                    <stop offset="1" stopColor="rgb(95, 30, 30);"/>
                                </radialgradient>
                                ...
                                <radialgradient id="gradient-13" gradientUnits="userSpaceOnUse" cx="34.864" cy="119.976"
                                    ...
                                    <stop offset="0" stopColor="rgb(67, 88, 0);"/>
                                    <stop offset="1" stopColor="rgb(173, 183, 141);"/>
                                </radialgradient>
                                <radialgradient id="gradient-14" gradientUnits="userSpaceOnUse" cx="41.572" cy="155.958"
                                    ...
                                    <stop offset="0" stopColor="rgb(64, 78, 18);"/>
                                    <stop offset="1" stopColor="#758d29"/>
                                </radialgradient>
                                <radialgradient id="gradient-15" gradientUnits="userSpaceOnUse" cx="107.613"
                                                cy="177.189"
                                                r="41.15"
                                                gradientTransform="matrix(0.722745, 0, 0, 0.553521, 18.427466, 66.94198)">
                                    <stop offset="0" stopColor="rgb(99, 121, 28);"/>
                                    <stop offset="1" stopColor="rgb(62, 76, 14);"/>
                                </radialgradient>
                                <lineargradient id="gradient-16" gradientUnits="userSpaceOnUse" x1="79.232" y1="148.661"
                                    ...
                                    <stop offset="1" stopColor="rgb(59, 72, 14);"/>
                                </lineargradient>
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0)" fill="url(#gradient-16)">
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0)" fill="url(#gradient-13)">
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0)" fill="url(#gradient-15)">
                            ...
                            <path
                                ...
                                fill="url(#gradient-4)" stroke="rgba(255, 0, 0, 0)">
                            ...
                            <path
                                ...
                                fill="url(#gradient-0);" stroke="rgba(255, 0, 0, 0);">
                            ...
                            <path
                                ...
                                fill="url(#gradient-1);" stroke="rgba(255, 0, 0, 0);"
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0);" fill="url(#gradient-14);">
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0);" fill="url(#gradient-7);">
                            ...
                            <path
                                ...
                                fill="url(#gradient-2);" stroke="rgba(0, 0, 0, 0);">
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0)" fill="url(#gradient-6)">
                            ...
                            <path
                                ...
                                stroke="rgba(23, 11, 11, 0)" fill="url(#gradient-8)">
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0)" fill="url(#gradient-11)">
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0)" fill="url(#gradient-9)">
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0)" fill="url(#gradient-10)">
                            ...
                            <path
                                ...
                                stroke="rgba(0, 0, 0, 0)" fill="url(#gradient-12)">
